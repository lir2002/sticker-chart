...
const translations: Translations = {
  ...
  orderCanceled: { en: "Order has been canceled, and amount is refunded", zh: "订单已取消，金额已退回" },
  ...
  refundFor: { en: "Refund for", zh: "退款" },
  deductionForRefund: { en: "Deduction for refund", zh: "退款扣除" },
  ...
  productNumber: {en: "Product Serial", zh: "产品序列号"}
};
