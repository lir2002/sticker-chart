...
const translations: Translations = {
  ...
  errorIncorrectCode: { en: "Incorrect verification code.", zh: "验证密码不正确。" },
  ...
  successUpdateCode: { en: "Verification code updated.", zh: "验证密码已更新。" },
  ...
  isVerified: { en: "Verified", zh: "已验证" },
  yes: { en: "Yes", zh: "是" },
  no: { en: "No", zh: "否" },
  delete: { en: "Delete", zh: "删除" },
  verifyDelete: { en: "Verify to Delete Event", zh: "验证以删除事件" },
  verifyEvent: { en: "Verify Event", zh: "验证事件" },
  eventDeleted: { en: "Event deleted successfully", zh: "事件删除成功" },
  eventVerified: { en: "Event verified successfully", zh: "事件验证成功" },
  errorDeleteEvent: { en: "Failed to delete event", zh: "删除事件失败" },
  errorVerifyEvent: { en: "Failed to verify event", zh: "验证事件失败" },
  noCurrentUser: { en: "No current user", zh: "无当前用户" },
  verified: { en: "Verified", zh: "已验证" },
  verifyDeleteEvent: { en: "Verify to Delete Event", zh: "验证以删除事件" },
  unknown: { en: "Unknown", zh: "未知" },
  creators: { en: "Creators", zh: "创建者" },
  verificationStatus: { en: "Verification Status", zh: "验证状态" },
  all: { en: "All", zh: "全部" },
